...
const modal = document.getElementById("modal"); // 모달 div
...
const addEntry = () => {
  ...
  entriesDiv.appendChild(entryDiv); // 일기 항목 div를 entriesDiv에 추가
...
//   diaryEntryTextarea.addEventListener("keydown", (event) => {
//     // textarea에서 Enter 키를 누를 때 addEntry 함수 실행
//     if (event.key === "Enter" && !event.shiftKey) {
//       event.preventDefault(); // Enter 키 기본 동작 방지
//       addEntry(); // addEntry 함수 실행
//     }
//   });
